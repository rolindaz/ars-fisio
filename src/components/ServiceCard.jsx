...
export default function ServiceCard({
  ...
  return (
    <>
      ...
      >
        <div
          className={`service-card-surface inner-card group flex w-full items-stretch justify-between gap-2 rounded-xl backdrop-blur-md shadow-md transition-all min-h-44 duration-500 hover:-translate-y-1 hover:shadow-lg ${align === "right" ? "flex-row-reverse text-right" : ""}`}
        >
          {/* Text */}
          <div className={`service-card-copy self-stretch py-5 ${align === "right" ? "pe-6 items-end" : "ps-6 items-start"}`}>
            <h3
